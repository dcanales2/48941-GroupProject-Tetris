...
Control::Control(QWidget *parent) : QWidget(parent)
{
    ...
    holdButton = new QPushButton(QKeySequence(BlocksBoard::getHoldButton()).toString( ));
    QObject::connect(holdButton,SIGNAL(clicked()),this,SLOT(holdControl()));
    ...
    holdButtonLabel = new QLabel("HOLD PIECE");
    ...
    vboxLayout1->addSpacing(50);
    vboxLayout1->addWidget(holdButton);
    ...
    vboxLayout2->addSpacing(50);
    vboxLayout2->addWidget(holdButtonLabel);
...
void Control::keyPressEvent(QKeyEvent *event)
{
    ...
    case cw:
        ...
        rotateCWButton->setEnabled(true);
         ...
         break;
    case hold:
        BlocksBoard::setHoldButton(key);
        holdButton->setText(QKeySequence(BlocksBoard::getHoldButton()).toString());
        selected = none;
